...
<?= $this->section('breadcrumb') ?>
    ...
    <li class="breadcrumb-item active">Nuovo Articolo</li>
<?= $this->endSection() ?>
    ...
    <div class="col-lg-9">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Nuovo Articolo</h3>
            </div>
            <form method="post" action="<?= base_url('magazzino') ?>">
                <?= csrf_field() ?>
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="cod_articolo" id="cod_articolo" class="form-control"
                                   ...
                                   value="<?= esc(old('cod_articolo')) ?>"
                                   placeholder="es. PFIT-001">
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="unita_misura" id="unita_misura" class="form-control"
                                   maxlength="10"
                                   value="<?= esc(old('unita_misura', 'N')) ?>"
                                   placeholder="N, pz, kg, l…">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" name="lotto_riordino" id="lotto_riordino" class="form-control"
                                   min="0" step="1"
                                   value="<?= esc(old('lotto_riordino', 0)) ?>">
                        </div>
                        <div class="form-group col-md-3">
                ...
                <div class="card-footer clearfix">
                    <a href="<?= base_url('magazzino') ?>" class="btn btn-secondary float-left">
                        <i class="fas fa-times mr-1"></i> Annulla
                    </a>
                    <button type="submit" class="btn btn-primary float-right">
                        <i class="fas fa-save mr-1"></i> Crea articolo
                    </button>
                </div>
            </form>
        </div>
...
<?= $this->section('help') ?>
<?= $this->include('help/magazzino/create') ?>
<?= $this->endSection() ?>
