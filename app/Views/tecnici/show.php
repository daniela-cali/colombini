            ...
            <div class="card-body text-center pt-4">
                <div class="mb-3">
                    <i class="fas fa-user-circle fa-5x"
                       style="color: <?= esc($tecnico->colore ?? 'var(--clr-teal)') ?>;"></i>
                </div>
...
<?= $this->section('help') ?>
<h5><i class="fas fa-id-card mr-1"></i> Scheda tecnico</h5>
<p>La scheda raccoglie l'anagrafica del tecnico, i contatori di attività del mese corrente (pianificati, in corso, completati) e l'elenco completo degli interventi assegnati.</p>
<h5><i class="fas fa-clock mr-1"></i> Orari di lavoro</h5>
